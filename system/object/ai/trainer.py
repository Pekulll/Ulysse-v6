def create_model(language='fr-FR', epochs=200):
    ...
    pickle.dump(words, open(f"./system/data/language/{language}/words.pkl", "wb"))
    pickle.dump(classes, open(f"./system/data/language/{language}/classes.pkl", "wb"))
    ...
    model.save(f"./system/data/language/{language}/model.h5", hist)
